...
class MTable:
    ...
    def read_item(o):
        ...
        if not pathname.startswith(marker):
            raise Exception('expected marker prefix "{0}", got "{1}"'.format(marker, pathname))
    ...
    def read_items(o):
        ...
        while True:
            ...
            if item.a==0:
                ...
                #print 'skipping invalid b:', item.filename
...
if __name__ == '__main__':
    ...
    test = True
    if test:
        buf = MTable('abc\x00def\x00ghi\x00\x00jkl\x00\x00\x00')
